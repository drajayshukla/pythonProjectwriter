...
def finalize_paper_structure():
    print("🚀 Finalizing 'paper.qmd' Structure...")
    ...
    # --- 2. DEFINE CONTENT ---
    # This content matches the requested YAML structure + body includes
...
"""
    ...
    try:
        ...
        with open(paper_path, "w", encoding="utf-8") as f:
            f.write(content)
        print(f"✅ SUCCESS: 'paper.qmd' updated successfully at: {paper_path}")
        print("   - Authors: Ajay Shukla, Sushil Gupta")
        print("   - Affiliation: Max Super Speciality Hospital")
        print("   - Linked Sections: 01-05 + References")
    except Exception as e:
        print(f"❌ ERROR: {e}")

    print("\n🚀 READY: Run 'quarto render manuscript/paper.qmd --to pdf'")


if __name__ == "__main__":
    finalize_paper_structure()